...
(function( $ )
{
    ...
    $.fn.wysiwyg = function( options )
    {
        ...
        options = $.extend({
            html : '<'+'?xml version="1.0" encoding="UTF-8"?'+'>'+
					...
					'<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">STYLE_SHEET'+
					'<style>::-webkit-scrollbar {width:12px;}::-webkit-scrollbar-thumb {-webkit-border-image: url(../img/ReaderThumb.png) 10 0 10 0 stretch stretch;border-width: 10px 0px;min-height: 40px;}::-webkit-scrollbar-track {-webkit-border-image: url(../img/ReaderTrack.png) 12 0 12 0 stretch stretch;border-width: 12px 0px;margin-bottom: 10px;}</style>'+
					'</head><body style="margin: 0px;">INITIAL_CONTENT</body></html>',
            css  : {},
    ...
    $.extend(Wysiwyg, {
        ...
        TOOLBAR : {
            ...
            h1mozilla : { visible : true && false, className : 'h1', command : 'heading', arguments : ['h1'], tags : ['h1'], tooltip : "Header 1" },
            h2mozilla : { visible : true && false, className : 'h2', command : 'heading', arguments : ['h2'], tags : ['h2'], tooltip : "Header 2" },
            h3mozilla : { visible : true && false, className : 'h3', command : 'heading', arguments : ['h3'], tags : ['h3'], tooltip : "Header 3" },

            h1 : { visible : true && !( false ), className : 'h1', command : 'formatBlock', arguments : ['<H1>'], tags : ['h1'], tooltip : "Header 1" },
            h2 : { visible : true && !( false ), className : 'h2', command : 'formatBlock', arguments : ['<H2>'], tags : ['h2'], tooltip : "Header 2" },
            h3 : { visible : true && !( false ), className : 'h3', command : 'formatBlock', arguments : ['<H3>'], tags : ['h3'], tooltip : "Header 3" },
            ...
            separator08 : { separator : false && !( false ) },

            increaseFontSize : { visible : false && !( false ), tags : ['big'], tooltip : "Increase font size" },
            decreaseFontSize : { visible : false && !( false ), tags : ['small'], tooltip : "Decrease font size" },
    ...
    $.extend(Wysiwyg.prototype,
    {
            ...
            if ( this.options.css && this.options.css.constructor == String )
	    {
            ...
            {
                if ( false && self.options.brIE && event.keyCode == 13 )
                {
